...
<div class="main-contracting-section position-realative z-index-100">
                ...
                <div class="col-12 col-md-11 position-relative">
                    <div class="px-3 px-sm-0">
                        <div class="title pb-4 pb-sm-3 pb-md-5">
                            <p class="d-inline-block font-18px theme color-gray font-octopus-500 uppercase position-relative after-border"><?php the_field('real_estate_title'); ?></p>
                        </div>
                        <div class="para">
                            <p class="para font-40px theme color-gray font-octopus-500"><?php the_field('real_estate_paragraph'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="civil-construction contracting z-index-100 position-relative">
        <div class="outer-image">
            <img src="<?php the_field('real_estate_civil_construction_image'); ?>" alt="" class="w-100">
            ...
            <div class="title position-absolute left-50 top-50 translate-center w-100">
                <p class="main-title theme color-white font-octopus-wide-700 font-36px text-center pb-2 drop-shadow-1"><?php the_field('real_estate_main_title'); ?></p>
                <p class="sub-title theme color-white font-octopus-wide-700 font-60px text-center drop-shadow-1"><?php the_field('real_estate_sub_title'); ?></p>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row d-flex justify-content-center py-5">
                    <div class="col-6 px-0 d-none d-md-block">
                        <div class="px-3 px-sm-0">
                            <?php
                                if (has_nav_menu('real_estate')) {
                                    wp_nav_menu(array(
                                        'theme_location' => 'real_estate',
                                        'container' => false,
                                        'menu_class' => 'menu-section real-estate-menu-section ps-0',
                                        )
                                    );
                                }
                            ?>
            ...
            <div class="py-5 row d-flex justify-content-center">
                <div class="col-12 col-sm-10 col-md-9">
                    <div class="content theme color-gray px-3 px-sm-0">
                        <?php the_field('real_estate_civil_construction_content'); ?>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="position-relative contact-address-sub-container contact-network-sub-container pt-3 pt-md-4 pt-lg-5 px-3 px-sm-0">
                ...
                ?>
                    <div class="position-relative">
                        ...
                        <a class="position-absolute top bottom left right" href="<?php the_permalink(); ?>"></a>
 ...
 ?>"/>
                    <button type="submit" value="Submit" name="re" value="submit" class="cursor-pointer explore-clients-text d-inline-block position-relative btn-hover-animation">
                        <a>Explore More!</a> 
                ...
                <div class="row py-5 px-2 px-sm-1">
                    <div class="col-12 col-sm-6">
                        <div class="image mx-auto px-5 px-sm-0">
                            <img class="img-fluid" src="<?php the_field('real_estate_experience_svg'); ?>" />
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 d-flex align-items-center">
                        <div class="content pt-5 pt-sm-0 font-36px">
                            <div class="font-36px font-octopus-wide-500 text-center text-sm-start"><?php the_field('real_estate_completed_civil_construction_text'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="construction-tabs civil-construction contracting theme bg-white-1 pt-0 position-relative z-index-100">
        <div class="contracting-elements realestate-elements position-absolute w-100">
            <div class="container">
                <div class="px-3 px-sm-0">
                    <div class="row d-flex justify-content-center py-5">
